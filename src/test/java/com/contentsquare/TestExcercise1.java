...
public class TestExcercise1 {
    ...
    @Before
    public void setUp() {
        target = "http://main.ctqatest.info/login.php";
        try {
    ...
    public void testLoginWithInvalidData(){
        ...
        loginAction.performLoginFlow();

        String expectedText = "Your Login Name or Password is invalid.\n" +
                "* try using 'test' for both ask kfir for BSF pass.";

        Assert.assertEquals(expectedText, loginAction.getErrorTextFlow());
    }
